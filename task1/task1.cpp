...
int main()
{
    ...
    std::cout << "Выберите, какое действие совершить:\n 1. Демонстрационный анализ на дефолтных входных значениях\n 2. Анализ на случайных входных значениях\n 3. Анализ на входных значениях от самого пользователя\n";
    int n;
    std::cin >> n;
...
void firstWay(std::vector<int>& vctCount, std::vector<std::string>& vctName)
{
    vctName = { "Кирилл", "Дима", "Вова", "Артур", "Кристина", "Карина", "Ваня", "Ю Джи Йоен", "Миша", "Рома" };
...
void middle(std::vector<int> vctCount)
{
    ...
    std::cout << std::endl << "Среднее значение: " << mid / (vctCount.size()) << std::endl;
}
